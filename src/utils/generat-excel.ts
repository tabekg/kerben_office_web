...
export const exportToExcel = async (
  ...
  worksheet.getCell('C6').value = 'ОсОО "Аль Нур"'
  ...
  let row = worksheet.addRow([
    `Задолженность Государственное предприятие\n"Таможенная инфраструктура" при Государственной таможенной службе\nпри Министерстве финансов Кыргызской Республике перед ОсОО "Аль Нур" на ${formatDateDDMMYYYY(
      new Date()
