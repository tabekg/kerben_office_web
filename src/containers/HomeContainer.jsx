     ...
     const list = useMemo(() => {
          return shipments
               ...
               .filter((g) =>
                    ...
                    g.last_route.sender.phone_number.toLowerCase().includes(searchInput.toLowerCase()) ||
                    g.last_route.truck_number.toLowerCase().includes(searchInput.toLowerCase()) ||
                    g.last_route.sender.full_name.toLowerCase().includes(searchInput.toLowerCase()),
               )
               .map((g) => {
